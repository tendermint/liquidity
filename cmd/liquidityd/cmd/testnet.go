...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "osmosid", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "osmosid", "Home directory of the node's cli configuration")
