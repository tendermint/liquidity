...
func TestGetExecutableAmt(t *testing.T) {
	...
	executableBuyAmtX, executableSellAmtY := orderBook.GetExecutableAmt(b)
...
func TestGetPriceDirection(t *testing.T) {
	...
	result := orderBook.GetPriceDirection(currentYPriceOverX)
...
func TestComputePriceDirection(t *testing.T) {
	...
	direction := orderBook.GetPriceDirection(currentYPriceOverX)
	...
	result = orderBook.Match(X, Y)
	require.Equal(t, orderBook.CalculateMatchStay(currentYPriceOverX), result)
}
...
func TestCalculateNoMatchEdgeCase(t *testing.T) {
	...
	require.NoError(t, err)
	var orderBook types.OrderBook
	orderbookEdgeCase := `[{"OrderPrice":"1.007768598527187219","BuyOfferAmt":"0","SellOfferAmt":"417269600","BatchPoolSwapMsgs":[{"msg_index":1,"executed":true,"exchanged_offer_coin":{"denom":"denomY","amount":"0"},"remaining_offer_coin":{"denom":"denomY","amount":"417269600"},"msg":{"swap_requester_address":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgqjwl8sq","pool_id":1,"pool_type_index":1,"offer_coin":{"denom":"denomY","amount":"417269600"},"demand_coin_denom":"denomX","order_price":"1.007768598527187219"}}]},{"OrderPrice":"1.011799672921295968","BuyOfferAmt":"0","SellOfferAmt":"2190665400","BatchPoolSwapMsgs":[{"msg_index":2,"executed":true,"exchanged_offer_coin":{"denom":"denomY","amount":"0"},"remaining_offer_coin":{"denom":"denomY","amount":"2190665400"},"msg":{"swap_requester_address":"cosmos15ky9du8a2wlstz6fpx3p4mqpjyrm5cgp0ctjdj","pool_id":1,"pool_type_index":1,"offer_coin":{"denom":"denomY","amount":"2190665400"},"demand_coin_denom":"denomX","order_price":"1.011799672921295968"}}]}]`
	json.Unmarshal([]byte(orderbookEdgeCase), &orderBook)
	r := orderBook.CalculateMatchStay(currentPrice)
