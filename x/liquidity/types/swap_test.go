...
func TestMaxOrderRatio(t *testing.T) {
	...
	msgBuy := types.NewMsgSwap(addrs[1], poolId, DefaultSwapType, offerCoin, DenomY, priceBuy)
	msgSell := types.NewMsgSwap(addrs[2], poolId, DefaultSwapType, offerCoinY, DenomX, priceSell)
