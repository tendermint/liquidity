...
type MsgSwap struct {
	...
	// id of the target pool
	PoolId uint64 `protobuf:"varint,2,opt,name=pool_id,json=poolId,proto3" json:"pool_id" yaml:"pool_id"`
	// index of swap type, only 1 is allowed on this version, Must match the value in the pool.
	SwapTypeIndex uint32 `protobuf:"varint,3,opt,name=swap_type_index,json=swapTypeIndex,proto3" json:"swap_type_index,omitempty" yaml:"swap_type_index"`
...
var fileDescriptor_0fd2153dc07d3b5c = []byte{
	...
	0x15, 0xd6, 0x8a, 0x94, 0x48, 0x8e, 0xfe, 0xac, 0x8d, 0xe2, 0xd2, 0xb2, 0x2d, 0x6e, 0x27, 0x76,
	0xa0, 0xc4, 0x16, 0x29, 0x92, 0x92, 0x2c, 0xab, 0x68, 0x8b, 0xa5, 0x68, 0xc5, 0xa4, 0xc2, 0xc0,
	0x5e, 0xca, 0xb2, 0x9d, 0xa2, 0x20, 0x96, 0xdc, 0xe1, 0x72, 0x2d, 0xee, 0x0e, 0xb9, 0xb3, 0x2b,
	...
	,
}
...
func (m *MsgSwap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	if m.SwapTypeIndex != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.SwapTypeIndex))
		i--
		dAtA[i] = 0x18
	}
	if m.PoolId != 0 {
...
func (m *MsgSwap) Size() (n int) {
	...
	if m.SwapTypeIndex != 0 {
		n += 1 + sovTx(uint64(m.SwapTypeIndex))
	}
	l = m.OfferCoin.Size()
	n += 1 + l + sovTx(uint64(l))
...
func (m *MsgSwap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SwapTypeIndex", wireType)
			}
			m.SwapTypeIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SwapTypeIndex |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
