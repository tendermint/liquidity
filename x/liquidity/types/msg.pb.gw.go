...
func request_MsgApi_SwapApi_0(ctx context.Context, marshaler runtime.Marshaler, client MsgApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.SwapApi(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func local_request_MsgApi_SwapApi_0(ctx context.Context, marshaler runtime.Marshaler, server MsgApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.SwapApi(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterMsgApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MsgApiServer) error {
	...
	mux.Handle("POST", pattern_MsgApi_SwapApi_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_MsgApi_SwapApi_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterMsgApiHandlerFromEndpoint is same as RegisterMsgApiHandler but
...
func RegisterMsgApiHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterMsgApiHandler(ctx, mux, conn)
}

// RegisterMsgApiHandler registers the http handlers for service MsgApi to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterMsgApiHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterMsgApiHandlerClient(ctx, mux, NewMsgApiClient(conn))
}

// RegisterMsgApiHandlerClient registers the http handlers for service MsgApi
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "MsgApiClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "MsgApiClient"
...
func RegisterMsgApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MsgApiClient) error {
	...
	mux.Handle("POST", pattern_MsgApi_SwapApi_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_MsgApi_SwapApi_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
