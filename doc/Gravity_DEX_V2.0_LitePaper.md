...
- migrate pool swap fee into adjusted quote price
    ...
    - fee rate concept should be replaced by "QuoteSpread"
        - <img src="https://render.githubusercontent.com/render/math?math=QuoteSpread = (HBP-LAP)/((HBP+LAP)/2)">
            - <img src="https://render.githubusercontent.com/render/math?math=HBP"> : highest bid price from the pool quotes
            - <img src="https://render.githubusercontent.com/render/math?math=LAP"> : lowest ask price from the pool quotes
