...
// need to validate alphabetical ordering of ReserveTokenDenoms when New() and Store
// Denominations can be 3 ~ 128 characters long and support letters, followed by either
// a letter, a number or a separator ('/').
// reDnmString = `[a-zA-Z][a-zA-Z0-9/]{2,127}`
func (lp LiquidityPool) getPoolKey() string {
	return GetPoolKey(lp.ReserveTokenDenoms, lp.PoolTypeIndex)
}

func GetPoolKey(reserveTokenDenoms []string, poolTypeIndex uint32) string {
	return strings.Join(append(reserveTokenDenoms, string(poolTypeIndex)), "-")
}
...
func (lp LiquidityPool) GetPoolTokenDenom() string         { return lp.PoolTokenDenom }
